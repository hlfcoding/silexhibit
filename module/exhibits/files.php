...
function getExhibitImages($id)
{
    ...
    if ($imgs)
    {
        foreach ($imgs as $img)
        {
            $body .= "<li class='box' id='box$img[media_id]'><img src='" . IMG_BASEURL . "/sys-$img[media_file]' width='75' title='$img[media_title]' /><br /><a href='#' onclick=\"getImgPreview($img[media_id]); return false;\">".$OBJ->lang->word('edit')."</a></li>\n";
        }
    }
    else
    {
