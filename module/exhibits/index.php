...
class Exhibits extends Router
{
    ...
    function page_view()
    {
        ...
        $body = "<div style='width:125px; float:left;'><img src='" . IMG_BASEURL . "/th-$rs[media_file]' width='100' /><br /><br /><a href='" . IMG_BASEURL . "/$rs[media_file]' target='_new'>" . $this->lang->word('view full size') . "</a></div>\n";
