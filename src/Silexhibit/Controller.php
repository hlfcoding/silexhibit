...
// Required Silex application globals, helpers, and services: `debug`, `env`,
// `url_generator`, `logger`, `mustache`, `merged`, `path`, `path.cache`,
// `config.vars`.
...
abstract class Controller
{
  ...
  // plugins and exhibits. Conventionally, components are generated by dedicated
  ...
  // `registerComponentFactories` should be called after the componentized view
  // registers.
