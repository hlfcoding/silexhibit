...
function createExhibit()
{
    ...
    foreach ($pages as $go)
    {
        ...
        $a .= "\n<span class='backgrounded'><a href='#' onclick=\"swapImg($i, '$go[media_file]');return false;\"><img src='" . IMG_BASEURL . "/sys-$go[media_file]' alt='$caption' title='$title' id='img$i' /></a></span>\n";
...
function dynamicJS()
{
    ...
    {
        var the_path = '" . IMG_BASEURL ."/' + image;
        show = new Image;
        show.src = the_path;
