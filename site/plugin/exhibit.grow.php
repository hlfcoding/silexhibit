    ...
    foreach ($pages as $go)
    {
        ...
        $a .= "<div class='thumb'>\n";
            $a .= "<div class='thumb-it'>\n";
                $a .= "<a href='#' class='thumb-img'   onclick=\"toggleImg($j,$go[media_x],$go[media_y],$go[thumbs]);return false;\"><img src='" . IMG_BASEURL . "/th-$go[media_file]' alt='$go[media_file]' title='$title' /></a>\n";
            $a .= "</div>\n";
